        ...
        {loading ? (
          ...
          <>
            ...
            {tab === "prescriptions" && prescriptions.length === 0 && (
              <div style={{ textAlign: "center", color: "#c7d2e8", fontSize: 11, fontFamily: "monospace", padding: 20 }}>No prescriptions found</div>
            )}
            {tab === "visits" && visits.length === 0 && (
              <div style={{ textAlign: "center", color: "#c7d2e8", fontSize: 11, fontFamily: "monospace", padding: 20 }}>No visits found</div>
            )}
            {tab === "calls" && calls.length === 0 && (
              <div style={{ textAlign: "center", color: "#c7d2e8", fontSize: 11, fontFamily: "monospace", padding: 20 }}>No call history found</div>
            )}
          </>
        )}
      </div>
